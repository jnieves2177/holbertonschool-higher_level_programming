...
class TestBase(unittest.TestCase):
    ...
    def test_private_attr_access(self):
        """Test private attrs are not accessible"""
    ...
    def test_to_json_string(self):
        ...
        self.assertTrue(isinstance(d0, dict))
        self.assertTrue(isinstance(strd01, str))
    ...
    def test_from_json_string(self):
        ...
        self.assertTrue(isinstance(s0, str))
        self.assertTrue(isinstance(strs0, list))
        self.assertTrue(isinstance(strs0[0], dict))
        self.assertTrue(strs0 == [d0, d1])
        self.assertTrue(strs0[0] == d0)

    def test_from_none_json_string(self):
        """Test no JSON string translates into empty Python dict"""
        s2 = None
        strs2 = Base.from_json_string(s2)
        self.assertTrue(isinstance(strs2, list))
    ...
    def test_from_empty_json_string(self):
        ...
        self.assertTrue(isinstance(strs3, list))
    ...
    """Test saving JSON string representation of dict to class-specific file"""
    ...
    """Test loading a list of instances from a JSON string representation of dict in a file"""
